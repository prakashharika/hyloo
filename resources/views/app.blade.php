...
<body>
    ...
    <!--------------- jQuery ---------------->
    <script data-cfasync="false" src="../../cdn-cgi/scripts/5c5dd728/cloudflare-static/email-decode.min.js')}}"></script><script src="{{asset('assets/js/jquery_3.7.1.min.js')}}"></script>
    ...
    <!--------------- additional-js ---------------->
    <script src="{{asset('assets/js/ecoshop.js')}}"></script>
